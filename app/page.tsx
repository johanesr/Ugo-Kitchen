...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up opacity-0 animation-delay-600">
            ...
            {/* <a
              href="#contact"
              className="inline-flex items-center justify-center px-8 py-4 border-2 border-brown text-brown rounded-full hover:bg-brown hover:text-cream transition-colors duration-300 text-sm tracking-wide"
            >
              {t.hero.ctaVisit}
            </a> */}
          </div>
      ...
      <section id="contact" className="py-24 px-6 bg-brown-dark text-cream">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16">
            {/* Visit Us */}
            <div>
              <p className="text-terracotta-light tracking-[0.2em] uppercase text-sm mb-4">
                {t.contact.visitTagline}
              </p>
              ...
              <div className="space-y-6 text-cream/80">
                ...
                {/* <div>
                  ...
                  <p>{t.contact.hoursValue1}</p>
                  <p>{t.contact.hoursValue2}</p>
                  <p className="text-sm text-cream/60 mt-1">
                    {t.contact.hoursNote}
                  </p>
                </div> */}
            ...
            <div>
              <p className="text-terracotta-light tracking-[0.2em] uppercase text-sm mb-4">
                {t.contact.connectTagline}
              </p>
              <h2 className="font-[family-name:var(--font-playfair)] text-4xl md:text-5xl mb-8">
                {t.contact.connectTitle}
              </h2>
              <p className="text-cream/80 mb-8">{t.contact.connectDescription}</p>

              {/* Social links placeholder */}
              <div className="flex gap-4">
                <a
                  href="#"
                  className="w-12 h-12 rounded-full bg-cream/10 hover:bg-cream/20 flex items-center justify-center transition-colors"
          ...
          {/* Footer */}
          <div className="mt-24 pt-8 border-t border-cream/10 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="font-[family-name:var(--font-playfair)] text-2xl">
              Ugo Kitchen
            </p>
            <p className="text-cream/60 text-sm">{t.contact.copyright}</p>
          </div>
        </div>
      </section>
    </div>
